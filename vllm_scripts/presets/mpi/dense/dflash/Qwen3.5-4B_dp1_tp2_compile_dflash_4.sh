#!/bin/bash
# Preset: Qwen3.5-4B with DFlash
# Configuration: DP=1, TP=2, PP=1, compile mode
...
export USER_VLLM_MODEL="Qwen/Qwen3.5-4B"
...
_VLLM_OPTIONAL_ARGS+=' --speculative-config {"model":"z-lab/Qwen3.5-4B-DFlash","num_speculative_tokens":4,"method":"dflash"}'
