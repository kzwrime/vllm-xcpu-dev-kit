#!/bin/bash
# Preset: Qwen3.6-35B-A3B-FP8
# Configuration: DP=2, TP=1, PP=1, enforce-eager mode, AG/RS EP
# MPI Processes: 2 (DP * TP * PP = 2 * 1 * 1)
...
_VLLM_OPTIONAL_ARGS+=" --all2all-backend allgather_reducescatter"
