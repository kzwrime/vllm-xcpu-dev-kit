...
export USER_VLLM_MODEL="${QWEN3_30B_A3B_FP8_MODEL_PATH:-Qwen/Qwen3-30B-A3B-Instruct-2507-FP8}"
...
export USER_VLLM_EP_SIZE="${USER_VLLM_EP_SIZE:-4}"
...
echo "AF-EP preset: ${preset_name} A=1 F=${USER_VLLM_EP_SIZE} ModelRunner=V2 eager FP8"
