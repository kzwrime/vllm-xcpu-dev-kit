#!/bin/bash
# Preset: Qwen3.5-0.8B multimodal TP1
...
export USER_VLLM_MODEL="Qwen/Qwen3.5-0.8B"
...
# Bound ViT profiling to 2,304 patch tokens while preserving the fixed test images.
_VLLM_OPTIONAL_ARGS+=' --mm-processor-kwargs {"max_pixels":589824}'
